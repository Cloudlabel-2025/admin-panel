...
const AttendanceSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ["Present", "Half Day", "Absent", "Logout Missing", "In Office", "Leave", "Weekend", "Holiday", "Half Day Leave"], required: true },
  leaveType: { type: String, default: "" },
  halfDayPeriod: { type: String, enum: ["first", "second"], default: "" },
  absenceId: { type: String, default: "" },
